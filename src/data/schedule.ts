...
const nightlyPeptides: DayDose[] = [
  { compoundId: 'ipamorelin', dose: '10 mg', timing: 'evening', category: 'peptide' },
  { compoundId: 'selank', dose: '15 mg', timing: 'evening', category: 'peptide' },
  { compoundId: 'ghk-cu', dose: '10 mg', timing: 'evening', category: 'peptide' },
  { compoundId: 'bpc-157', dose: '10 mg', timing: 'evening', category: 'peptide' },
];

// Common morning peptides (Mon-Sat)
const commonMorningPeptides: DayDose[] = [
  { compoundId: 'cjc-1295', dose: '10 mg', timing: 'morning', category: 'peptide' },
  { compoundId: 'semax', dose: '10 mg', timing: 'morning', category: 'peptide' },
  { compoundId: 'cerebroprotein', dose: '30 mg', timing: 'morning', category: 'peptide' },
];

// Evening CJC (every day)
const eveningCJC: DayDose = { compoundId: 'cjc-1295', dose: '10 mg', timing: 'evening', category: 'peptide' };

// Full peptide day extras (M/W/F)
const fullDayExtras: DayDose[] = [
  { compoundId: '5-amino-1mq', dose: '30 mg', timing: 'morning', category: 'peptide' },
  { compoundId: 'thymosin-a1', dose: '40 mg', timing: 'morning', category: 'peptide' },
  { compoundId: 'mots-c', dose: '50 mg', timing: 'morning', category: 'peptide' },
];

const tb500Evening: DayDose = { compoundId: 'tb-500', dose: '100 mg', timing: 'evening', category: 'peptide' };
...
// IGF-1 post-workout
const igf1: DayDose = { compoundId: 'igf1-lr3', dose: '15 mg', timing: 'afternoon', category: 'peptide' };

// Tesamorelin T/Th/Sa
const tesamorelin: DayDose = { compoundId: 'tesamorelin', dose: '20 mg', timing: 'evening', category: 'peptide' };

// B12 Tuesday
const b12: DayDose = { compoundId: 'b12', dose: '1mg (100 units)', timing: 'morning', category: 'peptide' };
...
const retatrutide: DayDose = { compoundId: 'retatrutide', dose: '15 mg', timing: 'evening', category: 'peptide' };
